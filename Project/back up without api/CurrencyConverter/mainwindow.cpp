    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->comboBox->addItem("AUD (Australian Dollar)");
    ui->comboBox->addItem("CAD (Canadian Dollar)");
    ui->comboBox->addItem("CNY (Chinese Yuan)");
    ui->comboBox->addItem("Euro (EU Currency)");
    ui->comboBox->addItem("KWD (Kuwaity Dinar)");
    ui->comboBox->addItem("MYR (Malaysian Ringgit)");
    ui->comboBox->addItem("Nrs (Nepalese rupee)");
    ui->comboBox->addItem("QAR (Qatari Riyal)");
    ui->comboBox->addItem("Rub (Russian Rouble)");
    ui->comboBox->addItem("Rupee (Indian Rupee)");
    ui->comboBox->addItem("SGD (Singapore Dollar)");
    ui->comboBox->addItem("USD (US Dollars)");
    ui->comboBox->addItem("Yen (Japanese Currency)");

     ui->comboBox_2->addItem("Choose Currency");
    ui->comboBox_2->addItem("AUD (Australian Dollar)");
    ui->comboBox_2->addItem("CAD (Canadian Dollar)");
    ui->comboBox_2->addItem("CNY (Chinese Yuan)");
    ui->comboBox_2->addItem("Euro (EU Currency)");
    ui->comboBox_2->addItem("KWD (Kuwaity Dinar)");
    ui->comboBox_2->addItem("MYR (Malaysian Ringgit)");
    ui->comboBox_2->addItem("Nrs (Nepalese rupee)");
    ui->comboBox_2->addItem("QAR (Qatari Riyal)");
    ui->comboBox_2->addItem("Rub (Russian Rouble)");
    ui->comboBox_2->addItem("Rupee (Indian Rupee)");
    ui->comboBox_2->addItem("SGD (Singapore Dollar)");
...
void MainWindow::on_pushButton_clicked()
{
    ...
    QString  second = ui->comboBox_2->currentText();
     ...
     if(first==second){
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Nepalese rupees exchange"
...
" exchange rate is the RUB to ...... rate. The currency code for Russian Rubles is RUB. The currency symbol is ₽.");
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Australian Dollar exchange"
...
" The currency symbol is A$.");
 ...
 ui->lineEdit_2->setText(QString::number(curr));
  ...
  ui->lineEdit_2->setText(QString::number(curr));
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Canadian Dollar exchange"
...
" The currency symbol is CA$.");
 ...
 ui->lineEdit_2->setText(QString::number(curr));
  ...
  ui->lineEdit_2->setText(QString::number(curr));
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Chinese yuan exchange"
...
" The currency symbol is CN¥.");
 ...
 ui->lineEdit_2->setText(QString::number(curr));
  ...
  ui->lineEdit_2->setText(QString::number(curr));
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Singapore dollar exchange"
...
" The currency symbol is S$.");
 ...
 ui->lineEdit_2->setText(QString::number(curr));
  ...
  ui->lineEdit_2->setText(QString::number(curr));
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Qatari Riyal exchange"
...
" The currency symbol is ر.ق.");
  ...
  ui->lineEdit_2->setText(QString::number(curr));
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Malaysian Ringgit exchange"
" rate is the  to ..... rate. The currency code for Malaysian Ringgit is MYR ."
" The currency symbol is RM.");
 ...
 ui->lineEdit_2->setText(QString::number(curr));
  ...
  ui->lineEdit_2->setText(QString::number(curr));
       ...
       ui->label_3->setText("Our currency rankings show that the most popular Kuwaity Dinar exchange"
